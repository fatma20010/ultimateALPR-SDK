...
# For Python 3.12+, imp module is removed, use direct import or importlib
if version_info >= (3, 12):
    # Python 3.12+ - direct import works since module is in same directory
    import _ultimateAlprSdk
elif version_info >= (3, 4):
    # Python 3.4-3.11 - use importlib
    def swig_import_helper():
        import importlib.util
        from os.path import dirname, join
        module_path = join(dirname(__file__), '_ultimateAlprSdk.pyd')
        try:
            spec = importlib.util.spec_from_file_location('_ultimateAlprSdk', module_path)
